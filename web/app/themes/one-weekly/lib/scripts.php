...
function roots_scripts() {
  wp_enqueue_style('roots_app', get_template_directory_uri() . '/dist/one-weekly.css', false, null);
  ...
  wp_register_script('typekit', '//use.typekit.net/ekp5roc.js', false, null, false );
  wp_register_script('typekit-test', get_template_directory_uri(). '/dist/typekit-test.js', array('typekit'), null, false);
